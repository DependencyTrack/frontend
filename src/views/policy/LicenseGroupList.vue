<template>
  <div class="animated fadeIn" v-permission="'POLICY_MANAGEMENT'">
    <div id="licenseGroupsToolbar" class="bs-table-custom-toolbar">
      <b-button size="md" variant="outline-primary" v-b-modal.createLicenseGroupModal v-permission="PERMISSIONS.POLICY_MANAGEMENT">
        <span class="fa fa-plus"></span> {{ $t('message.create_license_group') }}
      </b-button>
    </div>
    <bootstrap-table
      ref="table"
              ...
              methods: {
                updateLicenseGroup: function () {
                  ...
                  this.axios.post(url, {
                    ...
                    EventBus.$emit('policyManagement:licenseGroups:rowUpdate', index, this.licenseGroup);
                ...
                deleteLicenseGroup: function() {
                  ...
                  this.axios.delete(url).then((response) => {
                    EventBus.$emit('policyManagement:licenseGroups:rowDeleted', index);
