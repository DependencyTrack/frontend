...
// API Permissions
const PERMISSION_BOM_UPLOAD = "BOM_UPLOAD";
const PERMISSION_VIEW_PORTFOLIO = "VIEW_PORTFOLIO";
const PERMISSION_PORTFOLIO_MANAGEMENT = "PORTFOLIO_MANAGEMENT";
const PERMISSION_ACCESS_MANAGEMENT = "ACCESS_MANAGEMENT";
const PERMISSION_VULNERABILITY_ANALYSIS = "VULNERABILITY_ANALYSIS";
const PERMISSION_SYSTEM_CONFIGURATION = "SYSTEM_CONFIGURATION";
...
module.exports = {
  PERMISSION_BOM_UPLOAD: PERMISSION_BOM_UPLOAD,
  PERMISSION_VIEW_PORTFOLIO: PERMISSION_VIEW_PORTFOLIO,
  PERMISSION_PORTFOLIO_MANAGEMENT: PERMISSION_PORTFOLIO_MANAGEMENT,
  PERMISSION_VULNERABILITY_ANALYSIS: PERMISSION_VULNERABILITY_ANALYSIS,
  PERMISSION_ACCESS_MANAGEMENT: PERMISSION_ACCESS_MANAGEMENT,
  PERMISSION_SYSTEM_CONFIGURATION: PERMISSION_SYSTEM_CONFIGURATION,
  BASE_URL: BASE_URL,
