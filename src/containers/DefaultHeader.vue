<template>
  <AppHeader fixed>
    ...
    <img class="d-lg-inline d-md-none d-sm-none bv-d-xs-down-none" style="margin-left:10px" src="img/brand/logo-symbol-greyscale.svg" width="30" height="30" alt="Dependency-Track Logo"/>
